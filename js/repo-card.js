window.addEventListener('DOMContentLoaded', async function() {
  ...
  for (const el of document.querySelectorAll('.repo-card')) {
    ...
    el.innerHTML = `
    <div style="font-family: Lato,sans-serif,Apple Color Emoji,Segoe UI Emoji; border: 1px solid ${theme.borderColor}; border-radius: 6px; background: ${theme.background}; padding: 16px; font-size: 14px; line-height: 1.5; color: #24292e; height:11rem">
      ...
      <div style="font-size: 12px; color: ${theme.color}; display: flex; align-content: flex-end">
